    ...
    return (
      <Layout pageData={this.props.pageData} noPageData>
        <Grid container direction="column" spacing={40}>
          ...
          <Grid item xs={12}>
            <Typography variant="display3" component="h1" color="primary">
              Typography
            </Typography>
            <Typography>
                  ...
                  return (
                    <Grid item xs={12} key={typoName}>
                      ...
                      <Typography variant={typoName} component="h1">the quick brown fox jumps over the lazy
                        dogs</Typography>
                      <Typography variant={typoName} component="h1" style={{ textTransform: 'uppercase' }}>
          ...
          <Grid>
            ...
            <Grid container spacing={24}>
              <Grid item xs={12}>
                <Typography variant="display1" component="h2" color="primary">Main</Typography>
              </Grid>
              {
                ['primary', 'secondary', 'error'].map(color => (
                  <Grid item md={4} key={color}>
                    <Paper style={{ background: theme.palette[color].main, padding: 10 }}>
                      <Typography variant="headline" component="h4" style={{ color: theme.palette[color].contrastText }}>
                        {color.toUpperCase()}
                      </Typography>
                      <Typography variant="body2" component="p" style={{ color: theme.palette[color].contrastText }}>
