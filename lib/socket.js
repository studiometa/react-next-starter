...
export default class Socket {
   ...
   */
  async getSettings() {
    return await this.get(this._resolveUrl(config.api.endpoints.settings));
  };
  ...
  async getPage(pageId) {
    return await this.get(this._resolveUrl(config.api.endpoints.pages, pageId));
  };
   ...
   * @private
   */
  static _computeError(error = {}, message) {
